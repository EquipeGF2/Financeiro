...
const navigationSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      {
        label: 'Períodos Liberados',
        href: '/admin/periodos-liberados',
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
              strokeLinecap="round"
      ...
      {
        label: 'Importar Saldo Diário',
        href: '/admin/importar-saldo-diario',
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
              strokeWidth={2}
              d="M3 4a1 1 0 011-1h3.586a1 1 0 01.707.293l1.414 1.414A1 1 0 0010.414 5H20a1 1 0 011 1v12a1 1 0 01-1 1H4a1 1 0 01-1-1V4z"
            />
          </svg>
        ),
      },
